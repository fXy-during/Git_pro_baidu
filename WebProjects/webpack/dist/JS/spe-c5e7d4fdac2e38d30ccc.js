...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "JS/" + chunkId + "-" + {"0":"748e269247f9c4b4e4de","1":"c6db3e8759e7e07c628e","2":"59a6ff9ac5cbd213f0c5"}[chunkId] + ".js";
...
$(document).ready(function () {
    ...
    Init.getChartData(Init.format(currDate.getTime() - 60 * 24 * 60 * 60 * 1000, "yyyy-MM-dd"), Init.format(currDate, "yyyy-MM-dd"), '发帖量', table).getPackage().getPage('/event/specialEvent/pageCount').bindEvent().bindModule_RoMa().bindModule_Act();
