...
/******/ 		}
/******/ 		script.src = __webpack_require__.p + "JS/" + chunkId + "-" + {"0":"748e269247f9c4b4e4de","1":"9548693c8c70049fbdd3"}[chunkId] + ".js";
...
var _indexInit = __webpack_require__(0);

var Init = __webpack_require__(0).getInitObj();

console.log(_indexInit.signOut);
...
$(document).ready(function () {
    ...
    Init.getChartData(Init.format(currDate.getTime() - 60 * 24 * 60 * 60 * 1000, "yyyy-MM-dd"), Init.format(currDate, "yyyy-MM-dd"), '发帖量', table).getPackage().getPage('/event/dailyEvent/pageCount').bindEvent().bindModule_RoMa().bindModule_Act();
